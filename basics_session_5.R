...
ggplot(bio_data$forest,aes(beech,ndvi,colour=height))+geom_point()+geom_smooth()
ggplot(bio_data$forest,aes(beech,ndvi))+geom_point()+facet_wrap(~sub_basin)
...
ggplot(bio_data$forest,aes(x=beech,y=dvi))+geom_jitter()
